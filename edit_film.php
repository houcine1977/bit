...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        try {
            ...
            $sql = "UPDATE  movies SET title = '$titel', length_in_minutes = '$duur',
            released_at = '$datum', country_of_origin = '$land', summary = '$omschrijving',
            youtube_trailer_id = '$youtube' WHERE id = '$id'";
